...
export default function ProductoEdit({ producto, flash }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route('productos.update', producto.id), {
            onSuccess: () => notify.success('Producto actualizado correctamente.'),
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium text-gray-900">Editar Producto</span>
                </div>
            }
        >
            ...
            <div className="max-w-2xl">
                <Card>
                    <Card.Header title="Editar Producto" subtitle={producto.descripcion} />
                    <Card.Body>
                                ...
                                <div>
                                    ...
                                    {data.afecto_igv && data.precio_unitario && (
                                        <p className="mt-1 text-xs text-gray-500">
                                            Con IGV: <strong>S/ {precioConIgv}</strong>
                                        </p>
                                    )}
                                </div>
                            </div>
